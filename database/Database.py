...
class Pemasukan(Database):
    def __init__(self):
        ...
        attributeDescription = ["INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 10000", "INTEGER", "TEXT", "TEXT", "TEXT"]
...
class Transaksi(Database):
    def __init__(self):
        ...
        attributeDescription = ["INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 30000", "TEXT", "INTEGER REFERENCES Pemasukan(id_pemasukan) ON DELETE CASCADE, FOREIGN KEY (id_sumber) REFERENCES Pengeluaran(id_pengeluaran) ON DELETE CASCADE"]
        super().__init__(name, attributes, attributeDescription)
...
class Target(Database):
    def __init__(self):
        ...
        attributeDescription = ["INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 90000", "TEXT", "INTEGER", "TEXT", "TEXT", "TEXT"]
        super().__init__(name, attributes, attributeDescription)
...
class Pengeluaran(Database):
    def __init__(self):
        ...
        attributeDescription = ["INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 20000", "INTEGER", "TEXT", "TEXT", "TEXT"]
        super().__init__(name, attributes, attributeDescription)